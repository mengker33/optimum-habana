...
class GaudiQwenImageEditPlusPipeline(GaudiDiffusionPipeline, QwenImageEditPlusPipeline):
    ...
    def __init__(
        ...
        envvar = os.environ.get("QWENIMAGEEDITPLUS_VAE_DECODE_BUCKETS", "")
        if envvar != "":
        ...
        envvar = os.environ.get("QWENIMAGEEDITPLUS_VAE_ENCODE_BUCKETS", "")
        if envvar != "":
        ...
        encoder_hidden_states_buckets_step = int(
            os.environ.get("QWENIMAGEEDITPLUS_TRANSFORMER_ENCODER_BUCKETS_STEP", 256)
        )
        if use_hpu_graphs:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if negative_prompt_embeds is not None:
            ...
            max_prompt_embeds_len = prompt_embeds.shape[1]
